...
var DefaultControlContainer = styled__default['default'].ul(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  padding: 0;\n  margin: 10px;\n"], ["\n  display: flex;\n  justify-content: center;\n  padding: 0;\n  margin: 10px;\n"])));
var DefaultControlItem = styled__default['default'].li(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  list-style-type: none;\n  padding: 10px;\n  background: #fff;\n  border-right: 1px solid #c1c1c1;\n  border-top: 1px solid #c1c1c1;\n  border-bottom: 1px solid #c1c1c1;\n  color: #444;\n  cursor: pointer;\n  display: flex;\n  &:first-of-type {\n    border-left: 1px solid #c1c1c1;\n    border-top-left-radius: 5px;\n    border-bottom-left-radius: 5px;\n  }\n  &:last-of-type {\n    border-top-right-radius: 5px;\n    border-bottom-right-radius: 5px;\n  }\n  &.active {\n    background: #cfcfcf;\n  }\n"], ["\n  list-style-type: none;\n  padding: 10px;\n  background: #fff;\n  border-right: 1px solid #c1c1c1;\n  border-top: 1px solid #c1c1c1;\n  border-bottom: 1px solid #c1c1c1;\n  color: #444;\n  cursor: pointer;\n  display: flex;\n  &:first-of-type {\n    border-left: 1px solid #c1c1c1;\n    border-top-left-radius: 5px;\n    border-bottom-left-radius: 5px;\n  }\n  &:last-of-type {\n    border-top-right-radius: 5px;\n    border-bottom-right-radius: 5px;\n  }\n  &.active {\n    background: #cfcfcf;\n  }\n"])));
var DefaultPaginationContainer = styled__default['default'].div(templateObject_3 || (templateObject_3 = __makeTemplateObject([""], [""])));
...
var PaginatedList = function (_a) {
    ...
    if (isLoading === false)
        return (React.createElement(PaginatedListContainer, { className: paginatedListContainerClass },
            renderList && renderList(getCurrentPage(list, itemsPerPage, currentPageState)),
            React.createElement(PageNumbers, { items: getNumberOfPages(list, itemsPerPage), currentPageState: currentPageState, onPageNumberChange: onPageNumberChange, displayRange: displayRange, leftMargin: leftMargin, ControlContainer: ControlContainer, ControlItem: ControlItem, rightMargin: rightMargin, breakText: breakText, breakClass: breakClass, controlClass: controlClass, displayNumbers: displayNumbers, nextClass: nextClass, prevClass: prevClass, controlItemClass: controlItemClass, showPrev: showPrev, showNext: showNext, activeControlClass: activeControlClass, prevText: prevText, nextText: nextText, useMinimalControls: useMinimalControls })));
    else {
        return loadingItem();
    }
};
var PageNumbers = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ControlContainer, { className: controlClass },
            showPrev === true && hidePrev === false && (React.createElement(ControlItem, { className: prevCssClasses, onClick: handleBackward }, prevText)),
            displayNumbers &&
                finalArr.map(function (item, index) {
                    var breakTo = prevIndex + 1;
                    var shouldDisplayBreak = prevIndex + 1 !== item;
                    prevIndex = item;
                    return (React.createElement(Item, { key: index, item: item, breakTo: breakTo, ControlItem: ControlItem, currentPageState: currentPageState, shouldDisplayBreak: shouldDisplayBreak, breakText: breakText, breakClass: breakClass, controlItemClass: controlItemClass, onPageNumberChange: onPageNumberChange, activeControlClass: activeControlClass }));
                }),
            showNext === true && hideNext === false && (React.createElement(ControlItem, { className: nextCssClasses, onClick: handleForward }, nextText)))));
}; // Page number...
var Item = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        shouldDisplayBreak && (React.createElement(ControlItem, { onClick: handleBreakClick, className: [breakClass, controlItemClass] }, breakText)),
        React.createElement(ControlItem, { onClick: handleClick, className: (item === currentPageState ? activeControlClass : '') + " " + controlItemClass }, item + 1)));
};
