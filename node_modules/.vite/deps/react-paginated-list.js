...
var DefaultControlContainer = styled_components_browser_esm_default.ul(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  padding: 0;\n  margin: 10px;\n"], ["\n  display: flex;\n  justify-content: center;\n  padding: 0;\n  margin: 10px;\n"])));
var DefaultControlItem = styled_components_browser_esm_default.li(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  list-style-type: none;\n  padding: 10px;\n  background: #fff;\n  border-right: 1px solid #c1c1c1;\n  border-top: 1px solid #c1c1c1;\n  border-bottom: 1px solid #c1c1c1;\n  color: #444;\n  cursor: pointer;\n  display: flex;\n  &:first-of-type {\n    border-left: 1px solid #c1c1c1;\n    border-top-left-radius: 5px;\n    border-bottom-left-radius: 5px;\n  }\n  &:last-of-type {\n    border-top-right-radius: 5px;\n    border-bottom-right-radius: 5px;\n  }\n  &.active {\n    background: #cfcfcf;\n  }\n"], ["\n  list-style-type: none;\n  padding: 10px;\n  background: #fff;\n  border-right: 1px solid #c1c1c1;\n  border-top: 1px solid #c1c1c1;\n  border-bottom: 1px solid #c1c1c1;\n  color: #444;\n  cursor: pointer;\n  display: flex;\n  &:first-of-type {\n    border-left: 1px solid #c1c1c1;\n    border-top-left-radius: 5px;\n    border-bottom-left-radius: 5px;\n  }\n  &:last-of-type {\n    border-top-right-radius: 5px;\n    border-bottom-right-radius: 5px;\n  }\n  &.active {\n    background: #cfcfcf;\n  }\n"])));
var DefaultPaginationContainer = styled_components_browser_esm_default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject([""], [""])));
...
var PaginatedList = function(_a) {
  var list = _a.list, _b = _a.itemsPerPage, itemsPerPage = _b === void 0 ? 10 : _b, onPageChange = _a.onPageChange, renderList = _a.renderList, _c = _a.isLoading, isLoading = _c === void 0 ? false : _c, _d = _a.ControlItem, ControlItem = _d === void 0 ? DefaultControlItem : _d, _e = _a.ControlContainer, ControlContainer = _e === void 0 ? DefaultControlContainer : _e, _f = _a.PaginatedListContainer, PaginatedListContainer = _f === void 0 ? DefaultPaginationContainer : _f, _g = _a.loadingItem, loadingItem = _g === void 0 ? function() {
    return (0, import_react.createElement)("p", null, "Loading...");
  } : _g, _h = _a.breakText, breakText = _h === void 0 ? "..." : _h, _j = _a.breakClass, breakClass = _j === void 0 ? "pagination-break" : _j, _k = _a.displayRange, displayRange = _k === void 0 ? 3 : _k, _l = _a.leftMargin, leftMargin = _l === void 0 ? 1 : _l, _m = _a.rightMargin, rightMargin = _m === void 0 ? 1 : _m, _o = _a.currentPage, currentPage = _o === void 0 ? 1 : _o, _p = _a.displayNumbers, displayNumbers = _p === void 0 ? true : _p, _q = _a.loopAround, loopAround = _q === void 0 ? false : _q, _r = _a.nextClass, nextClass = _r === void 0 ? "next" : _r, _s = _a.prevClass, prevClass = _s === void 0 ? "prev" : _s, _t = _a.controlClass, controlClass = _t === void 0 ? "pagination" : _t, _u = _a.activeControlClass, activeControlClass = _u === void 0 ? "active" : _u, _v = _a.nextText, nextText = _v === void 0 ? "〉" : _v, _w = _a.prevText, prevText = _w === void 0 ? "〈" : _w, _x = _a.controlItemClass, controlItemClass = _x === void 0 ? "pagination-item" : _x, _y = _a.showPrev, showPrev = _y === void 0 ? true : _y, _z = _a.showNext, showNext = _z === void 0 ? true : _z, _0 = _a.useMinimalControls, useMinimalControls = _0 === void 0 ? false : _0, paginatedListContainerClass = _a.paginatedListContainerClass;
  var _1 = (0, import_react.useState)(currentPage - 1), currentPageState = _1[0], setcurrentPageState = _1[1];
  ...
  if (isLoading === false)
    return (0, import_react.createElement)(
      ...
      { className: paginatedListContainerClass },
      renderList && renderList(getCurrentPage(list, itemsPerPage, currentPageState)),
      (0, import_react.createElement)(PageNumbers, { items: getNumberOfPages(list, itemsPerPage), currentPageState, onPageNumberChange, displayRange, leftMargin, ControlContainer, ControlItem, rightMargin, breakText, breakClass, controlClass, displayNumbers, nextClass, prevClass, controlItemClass, showPrev, showNext, activeControlClass, prevText, nextText, useMinimalControls })
    );
  else {
    return loadingItem();
  }
...
var PageNumbers = function(_a) {
  ...
  var handleBackward = function() {
    return onPageNumberChange(currentPageState, -1);
  };
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      showPrev === true && hidePrev === false && (0, import_react.createElement)(ControlItem, { className: prevCssClasses, onClick: handleBackward }, prevText),
      displayNumbers && finalArr.map(function(item, index) {
        var breakTo = prevIndex + 1;
        var shouldDisplayBreak = prevIndex + 1 !== item;
        prevIndex = item;
        return (0, import_react.createElement)(Item, { key: index, item, breakTo, ControlItem, currentPageState, shouldDisplayBreak, breakText, breakClass, controlItemClass, onPageNumberChange, activeControlClass });
      }),
      showNext === true && hideNext === false && (0, import_react.createElement)(ControlItem, { className: nextCssClasses, onClick: handleForward }, nextText)
    )
  );
};
var Item = function(_a) {
  ...
  var handleClick = function() {
    return onPageNumberChange(item);
  };
  var handleBreakClick = function() {
    return onPageNumberChange(breakTo);
  };
  return (0, import_react.createElement)(
    import_react.Fragment,
    null,
    shouldDisplayBreak && (0, import_react.createElement)(ControlItem, { onClick: handleBreakClick, className: [breakClass, controlItemClass] }, breakText),
    (0, import_react.createElement)(ControlItem, { onClick: handleClick, className: (item === currentPageState ? activeControlClass : "") + " " + controlItemClass }, item + 1)
  );
};
export {
  PaginatedList
...
react-paginated-list/dist/index.esm.js:
  (*! *****************************************************************************
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=react-paginated-list.js.map
